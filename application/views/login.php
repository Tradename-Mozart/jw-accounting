...
<head>
	...
	<link rel="icon" href="<?= base_url('static/img/rewards_icon.png') ?>" sizes="32x26" type="image/png">
	...
	<style>
  	.bg-login-easy_rewards_bg 
		{
  		background: url("<?= base_url('static/img/accountingBannerImage.png') ?>");
            ...
            <div class="col-xl-10 col-lg-12 col-md-9">
                ...
                <div class="card o-hidden border-0 shadow-lg my-5">
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-block bg-login-easy_rewards_bg"></div>
                            <div class="col-lg-6">
                                <div class="p-5">
									
									<?php $this->load->view('validation_error'); ?>
                                    ...
                                    <hr>-->
                                    <div class="text-center">
                                        <!--<a class="small" href="forgot_access">Forgot Access Pin?</a>-->
                                    </div>
                                    <!--<div class="text-center">
